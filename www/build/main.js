...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_srvHttp__ = __webpack_require__(19);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_srvHttp__ = __webpack_require__(19);
        ...
        this.changePassword = function (oldPassword, newPassword) {
            ...
            if (_this.user && _this.user.num && _this.user.num.length > 0) {
                ...
                return _this.http.post(_this.srvHttp.SERVER_URL + _this.srvHttp.urlPassword, params, options)
                    ...
                    .subscribe(function (data) {
                    _this.srvGeneral.setMessage(_this.translate.instant("msg.valideMotdepasseModifie"), "", true);
                    //                  this.goHome();       
                }, function (err) { return _this.srvHttp.handleError(err); });
            }
        };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_srvHttp__ = __webpack_require__(19);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_srvHttp__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_srvGeneral__ = __webpack_require__(9);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var FamilleAlimentPage = /** @class */ (function () {
    ...
    FamilleAlimentPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["n" /* Component */])({
            selector: 'page-familleAliment',template:/*ion-inline-start:"C:\Projets\diabete\diabete_v3\client\webdia\src\pages\alimentTabs\familleAliment\familleAliment.html"*/'<ion-content padding class="background-color-aliment">\n  <div style="height:30px;">\n    <span class="txt-title">{{"frm.aliments.titre" | translate}}</span>\n  </div>\n  <ion-list class="list-conf-rb" no-lines >\n    <button  style="padding:3px 10px 3px 3px;border-bottom:1px solid grey" ion-item *ngFor="let famille of listFamille | OrderBy : [\'ordre\']" (click)="callAlimentFamille(famille)">\n      {{famille.nom}}\n    </button>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"C:\Projets\diabete\diabete_v3\client\webdia\src\pages\alimentTabs\familleAliment\familleAliment.html"*/,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_rxjs_add_operator_map__ = __webpack_require__(18);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_srvData__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_srvGeneral__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_srvHttp__ = __webpack_require__(19);
...
var SendDataPage = /** @class */ (function () {
    ...
    SendDataPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["n" /* Component */])({
            selector: 'page-sendData',template:/*ion-inline-start:"C:\Projets\diabete\diabete_v3\client\webdia\src\pages\dataTabs\sendData\sendData.html"*/'<ion-content padding class="background-color-donnees">\n  <div style="padding-bottom:10px;">\n    <span class="txt-title">{{"frm.data.titre" | translate}}</span>\n    <br>\n  </div>\n  <div style="color:#000;padding-bottom:10px">{{"frm.transfert.envoi"|translate}}</div>\n\n  <form (submit)="validateSendMail(true, formSendMail.value)" [formGroup]="formSendMail">\n\n    <ion-list> \n      <ion-item class="list-conf-rb itemConf">\n        <ion-input type="text" formControlName="mail" placeholder=\'{{"msg.inscription.email"|translate}}\'></ion-input>\n      </ion-item>\n    </ion-list>\n\n    <ion-grid>\n      <ion-row class="center">  \n        <ion-col width-90 class="center-col">\n          <button ion-button class="button-ok" type="submit" block>{{"button.ok"|translate}}</button>\n        </ion-col>\n      </ion-row>\n    </ion-grid>  \n\n  </form>\n\n</ion-content>\n'/*ion-inline-end:"C:\Projets\diabete\diabete_v3\client\webdia\src\pages\dataTabs\sendData\sendData.html"*/,
            ...
            _this.platform.ready().then(function () {
                if (_this.nom && _this.nom.length > 0) {
                    if (_this.nbHdc && _this.nbHdc.length > 0) {
                        _this.srvAliment.upload(_this.base64Image, _this.nom, Number.parseFloat(_this.nbHdc), _this.unite);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__providers_srvHttp__ = __webpack_require__(19);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_map___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_map__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_home_home__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_srvHttp__ = __webpack_require__(19);
        ...
        */
        ...
        this.deleteMesAliments = function (id) {
            ...
            if (_this.user && _this.user.num && _this.user.num.length > 0) {
                ...
                var params = "?id=" + id;
                _this.http.delete(_this.srvHttp.SERVER_URL + _this.srvHttp.urlMesdAliment + params, options_1)
                    .timeout(10000)
                    .map(function (res) {
...
var SrvGeneral = /** @class */ (function () {
    function SrvGeneral(app, modalCtrl, toastCtrl, alertCtrl, translate, loading) {
        ...
        this.setMessage = function (text, titre, goHome) {
            var alert = null;
            var options = {};
            if (!titre) {
                titre = 'Information';
